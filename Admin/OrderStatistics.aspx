...
<tr>
 <td height="26" >
  ...
  <td align="center" style="height: 22px">
      ...
      <tr>
          <td align="center" style="height: 22px">
              商品名称：<asp:TextBox ID="ShangPinName" runat="server"></asp:TextBox>
              开始时间：<input id="txttime" runat="server" onclick="fPopCalendar(event,this,this)" onfocus="this.select()"
                  ...
                  border-left: #cccccc 1px solid; border-bottom: #cccccc 1px solid" type="text" />结束时间：<input
                      id="Text1" runat="server" onclick="fPopCalendar(event,this,this)" onfocus="this.select()"
                      readonly="readonly" size="15" style="border-right: #cccccc 1px solid; border-top: #cccccc 1px solid;
