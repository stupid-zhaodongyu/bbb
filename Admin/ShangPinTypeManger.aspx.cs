...
public partial class Admin_ShangPinTypeManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from ShangPinType  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [ShangPinType] ";
    ...
    {
        data.RunSql("insert into ShangPinType(name)values('" + txtname.Text + "')");
        Alert.AlertAndRedirect("添加成功", "ShangPinTypeManger.aspx");
