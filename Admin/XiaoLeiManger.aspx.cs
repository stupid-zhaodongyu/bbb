...
public partial class AdminManger_XiaoLeiManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from XiaoLeiType  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [XiaoLeiType] ";
    ...
    {
        data.RunSql("insert into XiaoLeiType(name)values('" + txtname.Text + "')");
        Alert.AlertAndRedirect("添加成功", "XiaoLeiManger.aspx");
