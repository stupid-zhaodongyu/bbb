...
<tr>
 <td height="26" >
  ...
  <td align="center" style="height: 22px">
      信息类别管理<asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
          ...
          OnRowDeleting="gvInfo_RowDeleting" PageSize="17"
                        Width="100%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='XiuGaiXinWenLeiBie.aspx'
