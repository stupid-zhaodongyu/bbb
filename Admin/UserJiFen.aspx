<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserJiFen.aspx.cs" Inherits="Admin_UserJiFen" %>
                ...
                <td align="left" colspan="10" height="36">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="当前积分">
                                <ItemTemplate>
                                    <asp:Label ID="JiFen" runat="server" Text='<%# Bind("JiFen") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                       <asp:TemplateField HeaderText="积分详情">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ShowJiFen.aspx?id="+Eval("id") %>'
                                    Text="积分详情" Width="75px"></asp:HyperLink>
                            </ItemTemplate>
