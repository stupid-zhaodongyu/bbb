<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserZKList.aspx.cs" Inherits="Admin_UserZKList" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="年龄" SortExpression="Age">
                               ...
                               <asp:TemplateField HeaderText="折扣设置">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "SetZheKou.aspx?id="+Eval("id") %>'
                                    Text="折扣设置" Width="75px"></asp:HyperLink>
                            </ItemTemplate>
