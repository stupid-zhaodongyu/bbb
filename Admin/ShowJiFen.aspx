<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowJiFen.aspx.cs" Inherits="Admin_ShowJiFen" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="积分类型">
                                <ItemTemplate>
                                    <asp:Label ID="JiFenType" runat="server" Text='<%# Bind("JiFenType") %>' Width="104px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="60px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="积分数量">
                                <ItemTemplate>
                                    <asp:Label ID="jiFenNum" runat="server" Text='<%# Bind("jiFenNum") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="50px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="积分原因">
                                <ItemTemplate>
                                    <asp:Label ID="JiFenName" runat="server" Text='<%# Bind("JiFenName") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="操作时间">
                                <ItemTemplate>
                                    <asp:Label ID="AddTime" runat="server" Text='<%# Bind("AddTime") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
