                            ...
                            <asp:BoundField DataField="Ordeuser" HeaderText="订货人" />
                               ...
                               <asp:TemplateField HeaderText="订单操作">
                                  <ItemTemplate>
                                            ...
                                            <a href='OrderChk.aspx?OrderID=<%#DataBinder.Eval(Container.DataItem,"OrderID") %>'>订单操作 </a>
                                  </ItemTemplate>
                              </asp:TemplateField>
                            <asp:HyperLinkField HeaderText="订单详情" Text="订单详情" DataNavigateUrlFields="OrderID" DataNavigateUrlFormatString="EditOrder.aspx?OrderID={0}">
