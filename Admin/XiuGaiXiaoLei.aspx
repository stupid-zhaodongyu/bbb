<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiuGaiXiaoLei.aspx.cs" Inherits="AdminManger_XiuGaiXiaoLei" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="center" colspan="10" height="36">
                    <span style="font-family: Times New Roman">小类名称：</span><asp:TextBox ID="txtname" runat="server" Width="168px"></asp:TextBox>&nbsp;&nbsp;
