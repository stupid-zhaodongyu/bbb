<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiaoLeiManger.aspx.cs" Inherits="AdminManger_XiaoLeiManger" %>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="center" colspan="10" height="36">
                    小类名称：<asp:TextBox ID="txtname" runat="server" Width="216px"></asp:TextBox>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "XiuGaiXiaoLei.aspx?id="+Eval("id") %>'
