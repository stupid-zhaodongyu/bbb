<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KuCunList.aspx.cs" Inherits="AdminManger_KuCunList" %>
                ...
                <td align="left" colspan="10" height="36">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <asp:TemplateField HeaderText="商品名称">
                            <ItemTemplate>
                                <asp:Label ID="ShangPinName" runat="server" Text='<%# Bind("ShangPinName") %>' Width="255px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="分类">
                            <ItemTemplate>
                                <asp:Label ID="ShangPinTypeName" runat="server" Text='<%# Bind("ShangPinTypeName") %>' Width="130px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="销售单价">
                            <ItemTemplate>
                                <asp:Label ID="ShangPinPrice" runat="server" Text='<%# Bind("ShangPinPrice") %>' Width="130px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="商品数量">
                            <ItemTemplate>
                                <asp:Label ID="ShangPinNum" runat="server" Text='<%# Bind("ShangPinNum") %>' Width="130px"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                        </asp:TemplateField>
